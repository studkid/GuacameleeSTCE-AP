...
location_table: List[GuacLocation] = {
    ...
    # GuacLocationData(653, "EI", "Challenge Room #1 Bronze", "bronze"),
    # GuacLocationData(654, "EI", "Challenge Room #1 Silver", "silver"),
    # GuacLocationData(655, "EI", "Challenge Room #1 Gold", "gold"),
    # GuacLocationData(656, "EI", "Challenge Room #2 Bronze", "bronze"),
    # GuacLocationData(657, "EI", "Challenge Room #2 Silver", "silver"),
    # GuacLocationData(659, "EI", "Challenge Room #2 Gold", "gold"),
    # GuacLocationData(660, "EI", "Challenge Room #3 Bronze", "bronze"),
    # GuacLocationData(661, "EI", "Challenge Room #3 Silver", "silver"),
    # GuacLocationData(662, "EI", "Challenge Room #3 Gold", "gold"),
    # GuacLocationData(663, "EI", "Challenge Room #4 Bronze", "bronze"),
    # GuacLocationData(664, "EI", "Challenge Room #4 Silver", "silver"),
    # GuacLocationData(665, "EI", "Challenge Room #4 Gold", "gold"),
    # GuacLocationData(666, "EI", "Challenge Room #5 Bronze", "bronze"),
    # GuacLocationData(667, "EI", "Challenge Room #5 Silver", "silver"),
    # GuacLocationData(668, "EI", "Challenge Room #5 Gold", "gold"),
    # GuacLocationData(669, "EI", "Challenge Room #6 Bronze", "bronze"),
    # GuacLocationData(670, "EI", "Challenge Room #6 Silver", "silver"),
    # GuacLocationData(671, "EI", "Challenge Room #6 Gold", "gold"),
    # GuacLocationData(672, "EI", "Challenge Room #7 Bronze", "bronze"),
    # GuacLocationData(673, "EI", "Challenge Room #7 Silver", "silver"),
    # GuacLocationData(674, "EI", "Challenge Room #7 Gold", "gold"),
    # GuacLocationData(675, "EI", "Challenge Room #8 Bronze", "bronze"),
    # GuacLocationData(676, "EI", "Challenge Room #8 Silver", "silver"),
    # GuacLocationData(677, "EI", "Challenge Room #8 Gold", "gold"),
    # GuacLocationData(678, "EI", "Challenge Room #9 Bronze", "bronze"),
    # GuacLocationData(679, "EI", "Challenge Room #9 Silver", "silver"),
    # GuacLocationData(680, "EI", "Challenge Room #9 Gold", "gold"),
    # GuacLocationData(681, "EI", "Challenge Room #10 Bronze", "bronze"),
    # GuacLocationData(682, "EI", "Challenge Room #10 Silver", "silver"),
    # GuacLocationData(683, "EI", "Challenge Room #10 Gold", "gold"),
    # GuacLocationData(684, "EI", "Challenge Room #11 Bronze", "bronze"),
    # GuacLocationData(685, "EI", "Challenge Room #11 Silver", "silver"),
    # GuacLocationData(686, "EI", "Challenge Room #11 Gold", "gold"),
    # GuacLocationData(687, "EI", "Challenge Room #12 Bronze", "bronze"),
    # GuacLocationData(688, "EI", "Challenge Room #12 Silver", "silver"),
    # GuacLocationData(690, "EI", "Challenge Room #12 Gold", "gold"),
    # GuacLocationData(691, "EI", "Challenge Room #13 Bronze", "bronze"),
    # GuacLocationData(692, "EI", "Challenge Room #13 Silver", "silver"),
    # GuacLocationData(693, "EI", "Challenge Room #13 Gold", "gold"),
    # GuacLocationData(694, "EI", "Challenge Room #14 Bronze", "bronze"),
    # GuacLocationData(695, "EI", "Challenge Room #14 Silver", "silver"),
    # GuacLocationData(696, "EI", "Challenge Room #14 Gold", "gold"),
    # GuacLocationData(697, "EI", "Challenge Room #15 Bronze", "bronze"),
    # GuacLocationData(698, "EI", "Challenge Room #15 Silver", "silver"),
    # GuacLocationData(699, "EI", "Challenge Room #15 Gold", "gold"),
    # GuacLocationData(700, "EI", "Challenge Room #16 Bronze", "bronze"),
    # GuacLocationData(701, "EI", "Challenge Room #16 Silver", "silver"),
    # GuacLocationData(702, "EI", "Challenge Room #16 Gold", "gold"),
    # GuacLocationData(703, "EI", "Challenge Room #17 Bronze", "bronze"),
    # GuacLocationData(704, "EI", "Challenge Room #17 Silver", "silver"),
    # GuacLocationData(705, "EI", "Challenge Room #17 Gold", "gold"),

    # ChacMool Orbs 751-800
    GuacLocationData(751, "ChacMool", "Caverna Orb", "orb"),
    GuacLocationData(752, "ChacMool", "Sierra Orb", "orb"),
    GuacLocationData(753, "ChacMool", "Forest del Chivo Orb", "orb"),
    GuacLocationData(754, "ChacMool", "Tule Tree Orb", "orb"),
    GuacLocationData(755, "ChacMool", "Agave Field Orb", "orb"),
    GuacLocationData(756, "ChacMool", "Infierno Orb", "orb"),
}